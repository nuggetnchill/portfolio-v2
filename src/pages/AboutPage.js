    ...
    <>
      ...
      <div className='about-page'>
        ...
        <div className='about-grid'>
          <h1>About me</h1>
          <h2>
            I went to school for Business Marketing and did not go to school for
            Web Developing. I enjoy doing things that are creative and
            challenging whether via coding, editing photos & videos or
            aquascaping.
          </h2>
          <h3>🤖</h3>
          <ul>
